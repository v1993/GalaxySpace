...
public class CraftingRecipesOverworld {
    ...
    private static void addBlockRecipes() {
        ...
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.DECO_METALS, 4, 0), new Object[]{"YY ", "YYX", "   ", 'X', "plateCobalt", 'Y', Blocks.STONE});
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.DECO_METALS, 4, 1), new Object[]{"YY ", "YYX", "   ", 'X', "plateMagnesium", 'Y', Blocks.STONE});
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.DECO_METALS, 4, 2), new Object[]{"YY ", "YYX", "   ", 'X', "plateNickel", 'Y', Blocks.STONE});
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.DECO_METALS, 4, 3), new Object[]{"YY ", "YYX", "   ", 'X', plateCopper, 'Y', Blocks.STONE});

        RecipeUtil.addRecipe(new ItemStack(GSBlocks.DECO_METALS, 4, 4), new Object[]{"YY ", "YY ", " X ", 'X', "plateCobalt", 'Y', Blocks.STONE});
    ...
    private static void addItemRecipes() {
        ...
        RecipeUtil.addRecipe(new ItemStack(GSItems.SPACE_SUIT_LIGHT_HELMET), new Object[]{"XVX", "YZY", "XWX", 'X', GCItems.canvas, 'Y', plateAluminum, 'V', new ItemStack(GSItems.ADVANCED_BATTERY, 1, GSItems.ADVANCED_BATTERY.getMaxDamage()), 'Z', new ItemStack(GSItems.COBALT_HELMET), 'W', new ItemStack(Blocks.STAINED_GLASS_PANE, 1, OreDictionary.WILDCARD_VALUE)});
      ...
      */
        ...
        RecipeUtil.addRecipe(new ItemStack(GSItems.OXYGENTANK_TIER_4, 1, GSItems.OXYGENTANK_TIER_4.getMaxDamage()), new Object[]{"XYX", "ZCZ", "ZZZ", 'X', new ItemStack(Blocks.WOOL, 1, 11), 'Y', GCBlocks.oxygenPipe, 'C', new ItemStack(GCItems.oxTankHeavy, 1, OreDictionary.WILDCARD_VALUE), 'Z', new ItemStack(AsteroidsItems.basicItem, 1, 6)});
        RecipeUtil.addRecipe(new ItemStack(GSItems.OXYGENTANK_TIER_5, 1, GSItems.OXYGENTANK_TIER_5.getMaxDamage()), new Object[]{"XYX", "ZCZ", "ZZZ", 'X', new ItemStack(GCItems.oxygenConcentrator, 1, 0), 'Y', GCBlocks.oxygenPipe, 'C', new ItemStack(GSItems.OXYGENTANK_TIER_4, 1, OreDictionary.WILDCARD_VALUE), 'Z', new ItemStack(AsteroidsItems.basicItem, 1, 6)});
        RecipeUtil.addRecipe(new ItemStack(GSItems.OXYGENTANK_TIER_6, 1, GSItems.OXYGENTANK_TIER_6.getMaxDamage()), new Object[]{"XYA", "ZCZ", "ZZZ", 'X', new ItemStack(GCItems.oxygenVent, 1, 0), 'Y', GCBlocks.oxygenPipe, 'C', new ItemStack(GSItems.OXYGENTANK_TIER_5, 1, OreDictionary.WILDCARD_VALUE), 'Z', new ItemStack(AsteroidsItems.basicItem, 1, 6), 'A', GCItems.oxygenConcentrator});
